        ...
        <div className="flex items-center justify-between">
          ...
          <a href="#home" onClick={(e) => scrollToSection(e, "#home")} className="flex items-center gap-2 group">
            ...
            <span className="text-xl font-bold tracking-tight text-[#F5F5F5] group-hover:text-red-400 transition-colors">
              Asmit<span className="text-red-500"> Raj</span>
            </span>
          </a>

          {/* Desktop Nav */}
          <nav className="hidden md:flex items-center gap-1 bg-[#0D0D0D]/60 p-1.5 rounded-full border border-[#3F1111] backdrop-blur-md">
            {navItems.map((item) => {
          ...
          <div className="hidden md:flex">
            <a
              ...
              className="inline-flex items-center gap-2 px-4 py-2 text-sm font-semibold text-white bg-gradient-to-r from-red-800 to-red-600 rounded-lg shadow-lg shadow-red-900/30 hover:shadow-red-700/40 hover:scale-[1.02] active:scale-[0.98] transition-all"
            >
      ...
      <AnimatePresence>
        {mobileMenuOpen && (
          <motion.div
            ...
            className="md:hidden glass-nav border-b border-[#3F1111] overflow-hidden"
          >
            <div className="px-4 pt-3 pb-6 space-y-2">
              ...
              <div className="pt-3">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-full flex items-center justify-center gap-2 px-4 py-3 text-sm font-semibold text-white bg-gradient-to-r from-red-800 to-red-600 rounded-lg shadow-lg shadow-red-900/30"
                >
                  <FileDown className="w-4 h-4" />
                  Download Resume
                </a>
