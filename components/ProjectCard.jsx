  ...
  return (
    ...
    >
      ...
      <div className="p-6 sm:p-7 flex-1 flex flex-col justify-between space-y-6">
        <div className="space-y-4">
          ...
          {project.features && (
            <div className="space-y-2 pt-2 border-t border-[#3F1111]">
              ...
              <ul className="grid grid-cols-1 sm:grid-cols-2 gap-1.5 text-xs text-[#8A8A8A]">
        ...
        {/* Action Buttons */}
        <div className="flex items-center gap-3 pt-4 border-t border-[#3F1111]">
          <a
            href={project.github}
            target="_blank"
            rel="noopener noreferrer"
            className="flex-1 inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-[#0D0D0D] hover:bg-[#121212] border border-[#3F1111] hover:border-[#6B1A1A] text-xs font-semibold text-[#F5F5F5] transition-all hover:scale-[1.02]"
          >
          ...
          {project.isDesktopApp ? (
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex-1 inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-gradient-to-r from-red-800 to-red-600 hover:from-red-700 hover:to-red-500 text-xs font-semibold text-white shadow-lg shadow-red-900/30 transition-all hover:scale-[1.02]"
            >
