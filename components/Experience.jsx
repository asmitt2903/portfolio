    ...
    <section id="experience" className="py-24 relative z-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-4xl mx-auto relative">
          ...
          <div className="absolute left-4 md:left-1/2 top-0 bottom-0 w-0.5 bg-gradient-to-b from-red-800 via-red-600 to-red-900 -translate-x-1/2 opacity-50" />
          ...
          {experienceData.map((exp, idx) => (
            <motion.div key={idx} initial={{ opacity:0,y:30 }} whileInView={{ opacity:1,y:0 }} viewport={{ once:true }} transition={{ duration:0.6 }} className="relative mb-12 last:mb-0">
              ...
              <div className="ml-12 md:ml-0 md:w-1/2 md:pr-12 md:even:ml-auto md:even:pl-12 md:even:pr-0">
                <div className="glass-card p-6 sm:p-8 rounded-2xl relative group hover:border-[#6B1A1A] transition-all duration-300">
